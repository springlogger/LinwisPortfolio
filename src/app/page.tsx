  ...
  return (
    <div ref={containerRef} id="site-shell">
      ...
      <main className="relative flex flex-col items-center justify-center w-full">
        ...
        <div className="panel sticky top-0 h-dvh w-full overflow-hidden shadow-[0_-10px_30px_rgba(0,0,0,0.5)]" id="about">
          <div className="panel-inner h-full w-full bg-background relative will-change-transform">
            <AboutSection />
          </div>
        </div>
        
        <div className="panel sticky top-0 h-dvh w-full overflow-hidden shadow-[0_-10px_30px_rgba(0,0,0,0.5)]" id="skills">
          <div className="panel-inner h-full w-full bg-background relative will-change-transform">
            <SkillsSection />
          </div>
        </div>
        
        <div className="panel sticky top-0 h-dvh md:h-[400dvh] w-full shadow-[0_-10px_30px_rgba(0,0,0,0.5)]" id="projects-panel">
          <div className="panel-inner sticky top-0 h-dvh w-full bg-background overflow-hidden will-change-transform">
            <ProjectsSection />
          </div>
        </div>
        
        <div className="panel sticky top-0 min-h-dvh w-full overflow-hidden shadow-[0_-10px_30px_rgba(0,0,0,0.5)] flex flex-col" id="contact">
