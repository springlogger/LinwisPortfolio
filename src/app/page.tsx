  ...
  return (
    <div ref={containerRef}>
      ...
      <main className="relative flex flex-col items-center justify-center w-full">
        ...
        <div className="panel sticky top-0 h-svh w-full overflow-hidden shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
          <div className="panel-inner h-full w-full bg-background relative will-change-transform">
            <AboutSection />
          </div>
        </div>
        ...
        <div className="panel sticky top-0 h-svh md:h-[400dvh] w-full shadow-[0_-10px_30px_rgba(0,0,0,0.5)]" id="projects-panel">
          <div className="panel-inner sticky top-0 h-svh w-full bg-background overflow-hidden will-change-transform">
            <ProjectsSection />
          </div>
        </div>
        
        <div className="panel sticky top-0 min-h-svh w-full overflow-hidden shadow-[0_-10px_30px_rgba(0,0,0,0.5)] flex flex-col">
