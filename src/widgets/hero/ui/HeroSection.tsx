...
export function HeroSection() {
  return (
    <section className="relative min-h-svh w-full overflow-hidden bg-background" id="hero">
      ...
      <main className="relative z-10 grid min-h-svh w-full grid-cols-1 items-center gap-6 lg:gap-10 px-6 pb-10 pt-28 sm:pt-30 lg:pt-24 sm:px-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,0.78fr)] lg:px-16">
